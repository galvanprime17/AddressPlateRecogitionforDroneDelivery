...
def extract_frames(video_path, frames_dir, overwrite=False, start=-1, end=-1, every=1):
    ...
    video_path = os.path.abspath("Sample1.mp4")
    frames_dir = os.path.abspath("data")
    video_dir, video_filename = os.path.split("Sample1.mp4")  # get the video path and filename from the path
    assert os.path.exists("Sample1.mp4")  # assert the video file exists
